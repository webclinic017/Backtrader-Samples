...
class SmaCross(bt.Strategy):
    ...
    def prenext(self):
        ...
        print(self.datetime.datetime(), self.data0.datetime.datetime(),self.data1.datetime.datetime())
...
if __name__=='__main__':
    ...
    # 拼接得到数据文件全路径
    datapath = os.path.join(modpath, './600000d2.csv')  # 日线数据
    datapath2 = os.path.join(modpath, './600000m.csv')  #周线数据
