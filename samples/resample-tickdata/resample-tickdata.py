...
def runstrat():
    ...
    # Load the Data
    datapath = args.dataname or './samples/datas/ticksample.csv'
    ...
    # Resample the data
    print('timeframet',args.timeframe,'compress', args.compression, 'nobar2edge', args.nobar2edge,'noadjbartime', args.noadjbartime,'rightedge', args.rightedge)
